...
def main(argv=None):
    ...
    ap.add_argument("firmware"); ap.add_argument("--suffix",default="FC1B"); ap.add_argument("--output",default="analysis/public_suffix_research"); ap.add_argument("--json",action="store_true"); ap.add_argument("--no-modify",action="store_true")
